...
export interface ReportSpec {
  ...
  countType: CountType;          // How to count affected entities (e.g., 'mapIcons', 'territories')
...
export const BUILTIN_REPORTS: Record<string, ReportSpec> = {
  ...
  'capabilities-naval': {
    ...
    defaultLayers: { structures: true, territories: true, resources: false, casualties: false, minorLocations: false },
    reportContextGroup: 'threats',
    metadata: { stackComparisonIcons: [MapIcon.Shipyard, MapIcon.Seaport] },
    source: 'builtin',
  },
  'capabilities-aircraft': {
    id: 'capabilities-aircraft',
    name: 'Aircraft Capabilities',
    image: 'Tile_Report_Aircraft',
    ...
    defaultLayers: { structures: true, territories: true, resources: false, casualties: false, minorLocations: false },
    reportContextGroup: 'threats',
    metadata: { stackComparisonIcons: [MapIcon.Aircraft_Factory, MapIcon.Aircraft_Depot, MapIcon.Aircraft_Radar] },
    source: 'builtin',
  },
  'capabilities-production': {
    ...
    defaultLayers: { structures: true, territories: true, resources: false, casualties: false, minorLocations: false },
    reportContextGroup: 'threats',
    metadata: { stackComparisonIcons: [MapIcon.Factory, MapIcon.Mass_Production_Factory] },
    source: 'builtin',
  },
  ...
  'capabilities-storage': {
    id: 'capabilities-storage',
    name: 'Storage',
    tooltip: 'Showing storage-related structures',
    category: 'Economy',
    ...
    defaultLayers: { structures: true, territories: true, resources: false, casualties: false, minorLocations: false },
    reportContextGroup: 'threats',
    metadata: { stackComparisonIcons: [MapIcon.Storage_Facility, MapIcon.Seaport] },
    source: 'builtin',
  },
  'capabilities-salvage': {
    id: 'capabilities-salvage',
    name: 'Salvage',
    tooltip: 'Showing Salvage-related structures',
    category: 'Economy',
    mapIconTags: [MapIconTag.Resource_Salvage],
    viewMode: 'territoryDimming',
    highlightType: 'mapIconTags',
    countType: 'mapIconsByTerritory',
    defaultLayers: { structures: true, territories: true, resources: false, casualties: false, minorLocations: false },
    reportContextGroup: 'threats',
    metadata: { stackComparisonIcons: [MapIcon.Salvage_Field, MapIcon.Salvage_Mine] },
    source: 'builtin',
  },
